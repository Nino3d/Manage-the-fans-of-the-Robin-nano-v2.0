...
//
  ...
  //#define HEATER_CHAMBER_PIN      P0_27  // Required heater on/off pin (example: SKR 1.4 Turbo HE1 plug)
  //#define HEATER_CHAMBER_INVERTING false
  #define FAN1_PIN            PB1         // Remove the fan signal on pin P2_04 (example: SKR 1.4 Turbo HE1 plug)
...
//
  ...
  #define COOLER_FAN_INDEX         1  // FAN number 0, 1, 2 etc. e.g.
 ...
 */
  ...
  #define PID_FAN_SCALING
    ...
    //#define PID_FAN_SCALING_ALTERNATIVE_DEFINITION
      ...
      #define PID_FAN_SCALING_MIN_SPEED     5.0        // Minimum fan speed at which to enable PID_FAN_SCALING
